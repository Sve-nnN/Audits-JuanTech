...
- [ ] **FPRINT-02**: El sistema detecta el CMS principal del sitio (WordPress, Shopify, Webflow, Wix, Squarespace, o "no detectado") con un nivel de confianza (alto/medio/bajo)
...
- [ ] **FPRINT-07**: El sistema detecta herramientas de analytics/tag manager en uso (ej. GA4, GTM, Meta Pixel)
- [ ] **FPRINT-08**: Cuando la confianza de detección es baja o no hay señal, el sistema muestra "no detectado con certeza" en vez de forzar una respuesta incorrecta
