...
Plans:
- [ ] 25-01-PLAN.md — Scaffold `@auditor/fingerprint` + contrato de datos (DetectedStack/AxisResult/Confidence/Signature/PageFingerprintInput) [wave 1]
...
| 25. Fingerprint de stack técnico — contrato de datos y motor de detección | v1.5 | 0/4 | Planned | - |
