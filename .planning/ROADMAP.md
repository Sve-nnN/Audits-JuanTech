...
- [x] 22-03-PLAN.md — mapa de arquitectura en página aparte con zoom/pan/drag + tarjeta-link en el reporte [ARCH-06] (código completo; pendiente verificación visual de Juan)
